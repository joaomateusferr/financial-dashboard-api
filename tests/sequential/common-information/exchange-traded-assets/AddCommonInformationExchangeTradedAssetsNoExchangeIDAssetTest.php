...
final class AddCommonInformationExchangeTradedAssetsNoExchangeIDAssetTest extends HTTPResponseTest {
    ...
    public static function setUpBeforeClass(): void {
        ...
        curl_setopt($Curl, CURLOPT_POSTFIELDS, json_encode([["Ticker" => "HGLG", "AssetQualificationID" => 11, "AssetTypeID" => 11, "IsoCode" => "BRL"]]));
    ...
    public function testResponseDefaultExpectedMessage(): void {
        ...
        $this->assertSame($ResponseArray['result'][0], 'I - 0 - ExchangeID is required for assets not denominated in dollars!');
