...
final class AddCommonInformationExchangeTradedAssetsValidBrlWithSubtypeAssetTest extends HTTPResponseTest {
    ...
    public static function setUpBeforeClass(): void {
        ...
        curl_setopt($Curl, CURLOPT_POSTFIELDS, json_encode([["Ticker" => "NDIV", "AssetQualificationID" => 11, "ExchangeID" => 1, "AssetTypeID" => 3, "AssetSubtypeID" => 4, "IsoCode" => "BRL"]]));
    ...
    public function testResponseDefaultExpectedMessage(): void {
        ...
        $this->assertSame($ResponseArray['result']['Success'][0], 'NDIV11');
