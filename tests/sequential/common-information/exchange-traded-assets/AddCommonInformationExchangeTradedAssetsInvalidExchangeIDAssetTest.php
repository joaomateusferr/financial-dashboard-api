...
final class AddCommonInformationExchangeTradedAssetsInvalidExchangeIDAssetTest extends HTTPResponseTest {
    ...
    public static function setUpBeforeClass(): void {
        ...
        curl_setopt($Curl, CURLOPT_POSTFIELDS, json_encode([["Ticker" => "HGLG", "AssetQualificationID" => 11, "ExchangeID" => 999999, "AssetTypeID" => 11, "IsoCode" => "BRL"]]));
    ...
    public function testResponseDefaultExpectedMessage(): void {
        ...
        $this->assertSame($ResponseArray['result'][0], 'Invalid exchange ID (999999)!');
