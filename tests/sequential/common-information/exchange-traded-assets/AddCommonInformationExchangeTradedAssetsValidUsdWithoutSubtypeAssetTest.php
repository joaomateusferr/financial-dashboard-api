...
final class AddCommonInformationExchangeTradedAssetsValidUsdWithoutSubtypeAssetTest extends HTTPResponseTest {
    ...
    public static function setUpBeforeClass(): void {
        ...
        curl_setopt($Curl, CURLOPT_POSTFIELDS, json_encode([["Ticker" => "AAPL", "AssetTypeID" => 2, "IsoCode" => "USD"]]));
    ...
    public function testResponseDefaultExpectedMessage(): void {
        ...
        $this->assertSame($ResponseArray['result']['Success'][0], 'AAPL');
