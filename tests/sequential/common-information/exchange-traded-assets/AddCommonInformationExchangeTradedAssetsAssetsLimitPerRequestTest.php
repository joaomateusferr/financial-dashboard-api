...
final class AddCommonInformationExchangeTradedAssetsAssetsLimitPerRequestTest extends HTTPResponseTest {
    ...
    public static function setUpBeforeClass(): void {
        ...
        $Payload = [
            ["Ticker" => "HGLG", "AssetQualificationID" => 11, "ExchangeID" => 1, "AssetTypeID" => 11, "IsoCode" => "BRL"],
            ["Ticker" => "MXRF", "AssetQualificationID" => 11, "ExchangeID" => 1, "AssetTypeID" => 11, "IsoCode" => "BRL"],
            ["Ticker" => "KNRI", "AssetQualificationID" => 11, "ExchangeID" => 1, "AssetTypeID" => 11, "IsoCode" => "BRL"]
        ];
    ...
    public function testResponseDefaultExpectedMessage(): void {
        ...
        $this->assertSame($ResponseArray['result'][0], 'Asset limit per request is '.ApiLimitsConstants::getExchangeTradedAssetsPost().'!');
