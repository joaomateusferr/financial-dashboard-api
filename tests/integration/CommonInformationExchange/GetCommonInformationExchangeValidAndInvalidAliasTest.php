...
final class GetCommonInformationExchangeValidAndInvalidAliasTest extends HTTPResponseTest {
    ...
    public static function setUpBeforeClass(): void {
        ...
        curl_setopt($Curl, CURLOPT_POSTFIELDS, json_encode(['B3','InvalidAlias']));
    ...
    public function testResponseDefaultExpectedValues(): void {
        ...
        $this->assertTrue(isset($ResponseArray['result']['B3']));
