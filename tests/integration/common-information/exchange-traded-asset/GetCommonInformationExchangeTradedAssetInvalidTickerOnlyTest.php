...
final class GetCommonInformationExchangeTradedAssetInvalidTickerOnlyTest extends HTTPResponseTest {
    ...
    public static function setUpBeforeClass(): void {
        ...
        curl_setopt($Curl, CURLOPT_POSTFIELDS, json_encode(['InvalidTicker']));
