...
final class GetCommonInformationExchangeTradedAssetValidAndInvalidTickerTest extends HTTPResponseTest {
    ...
    public static function setUpBeforeClass(): void {
        ...
        curl_setopt($Curl, CURLOPT_POSTFIELDS, json_encode(['AAPL', 'InvalidTicker']));
    ...
    public function testResponseDefaultExpectedValues(): void {
        ...
        $this->assertTrue(isset($ResponseArray['result']['AAPL']));
