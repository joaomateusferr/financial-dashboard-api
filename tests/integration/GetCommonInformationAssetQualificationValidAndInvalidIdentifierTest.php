...
final class GetCommonInformationAssetQualificationValidAndInvalidIdentifierTest extends HTTPResponseTest {
    ...
    public static function setUpBeforeClass(): void {
        ...
        curl_setopt($Curl, CURLOPT_POSTFIELDS, json_encode([11,999999]));
