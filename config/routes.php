...
$Routes = [
    'GET' => [
        ...
        'ConsolidatedExchangeTradedAssets' => ['Arguments' => ['CustomerID'],'Midwares' => [['Class' => 'AuthenticationMidware', 'Method' => 'validateCustomerToken', 'RequireRequest' => true]], 'Controller' => 'ConsolidatedExchangeTradedAssetsController', 'Method' => 'getConsolidatedExchangeTradedAssets', 'RequireRequest' => true]
    ],
    'POST' => [
